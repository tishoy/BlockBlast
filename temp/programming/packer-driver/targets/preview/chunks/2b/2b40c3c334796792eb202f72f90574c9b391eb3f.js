      ...
      _export("Block", Block = (_dec = ccclass('Block'), _dec2 = property({
        ...
        generate() {
          ...
          var _loop = function _loop() {
            ...
            console.log((_crd && ColorEnum === void 0 ? (_reportPossibleCrUseOfColorEnum({
              error: Error()
            }), ColorEnum) : ColorEnum).COLOR_RES[_this.color]);
            resources.load('texture/' + (_crd && ColorEnum === void 0 ? (_reportPossibleCrUseOfColorEnum({
              error: Error()
            }), ColorEnum) : ColorEnum).COLOR_RES[_this.color], SpriteFrame, (err, asset) => {
              node.getChildByName("Grid").getComponent(Sprite).spriteFrame = asset;
              console.log(node.getChildByName("Grid").getComponent(Sprite));
            });
            resources.load('texture/grid3/spriteFrame', SpriteFrame, (err, asset) => {
              _this.node.getChildByName("Grid").getComponent(Sprite).spriteFrame = asset;
            });
...
//# sourceMappingURL=2b40c3c334796792eb202f72f90574c9b391eb3f.js.map