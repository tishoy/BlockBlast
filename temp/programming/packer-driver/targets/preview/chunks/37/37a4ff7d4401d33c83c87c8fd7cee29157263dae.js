System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, CCInteger, Component, instantiate, NodeEventType, Prefab, UITransform, Vec2, Vec3, BlockEnum, GameController, ColorEnum, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, Block;
        ...
        generate() {
          ...
          for (var i = 0; i < data.length; i++) {
            ...
            console.log('texture/' + (_crd && ColorEnum === void 0 ? (_reportPossibleCrUseOfColorEnum({
              error: Error()
            }), ColorEnum) : ColorEnum).COLOR_RES[this.color] + '/spriteFrame'); // resources.load('texture/' + ColorEnum.COLOR_RES[this.color] + "/spriteFrame", SpriteFrame, (err, asset) => {
            //     console.log(err, asset)
            //     console.log(node.getChildByName("Grid").getComponent(Sprite).spriteFrame);
...
//# sourceMappingURL=37a4ff7d4401d33c83c87c8fd7cee29157263dae.js.map