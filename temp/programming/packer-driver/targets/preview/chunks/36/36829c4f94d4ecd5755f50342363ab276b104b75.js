      ...
      _export("GameArea", GameArea = (_dec = ccclass('GameArea'), _dec2 = property({
        ...
        getGridByPosition(pos) {
          ...
          for (var i = 0; i < 64; i++) {
            ...
            var distance = Math.sqrt(Math.pow(pos.x - this.grids[i].getPosition().x + 40, 2) + Math.pow(pos.y - this.grids[i].getPosition().y - 120 + 40, 2));
...
//# sourceMappingURL=36829c4f94d4ecd5755f50342363ab276b104b75.js.map