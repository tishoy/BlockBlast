      ...
      _export("GameArea", GameArea = (_dec = ccclass('GameArea'), _dec2 = property({
        ...
        getGridByPosition(pos) {
          ...
          for (var i = 0; i < 64; i++) {
            ...
            var distance = Math.sqrt(Math.pow(pos.x - this.node.getPosition().x + this.grids[i].getPosition().x + 40, 2) + Math.pow(pos.y - this.node.getPosition().y + this.grids[i].getPosition().y - 120 + 40, 2));
...
//# sourceMappingURL=5c88102662c492cfbae6814f24a05b103557dee8.js.map