    ...
    execute: function () {
      ...
      _export("Block", Block = (_dec = ccclass('Block'), _dec2 = property({
        ...
        touchMove(event) {
          ...
          this.node.setPosition(new Vec3(event.touch._point.x - event.touch._startPoint.x, event.touch._point.y - event.touch._startPoint.y));
        }
...
//# sourceMappingURL=c8337c7b750cab10606eae6c42530f4be24972cc.js.map