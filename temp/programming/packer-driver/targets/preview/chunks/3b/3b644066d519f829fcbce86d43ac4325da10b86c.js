      ...
      _export("GameArea", GameArea = (_dec = ccclass('GameArea'), _dec2 = property({
        ...
        getGridByPosition(pos) {
          ...
          for (var i = 0; i < 64; i++) {
            ...
            var distance = Math.sqrt(Math.pow(pos.x - this.node.getPosition().x - this.grids[i].getPosition().x, 2) + Math.pow(pos.y - this.node.getPosition().y - this.grids[i].getPosition().y - 160, 2));
...
//# sourceMappingURL=3b644066d519f829fcbce86d43ac4325da10b86c.js.map