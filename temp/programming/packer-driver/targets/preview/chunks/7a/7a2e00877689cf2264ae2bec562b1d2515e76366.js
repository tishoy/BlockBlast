      ...
      _export("GameArea", GameArea = (_dec = ccclass('GameArea'), _dec2 = property({
        ...
        getGridByPosition(pos) {
          ...
          for (var i = 0; i < 64; i++) {
            ...
            var distance = Math.sqrt(Math.pow(pos.x - this.node.getPosition().x - this.grids[i].getPosition().x, 2) + Math.pow(pos.y - this.node.getPosition().y - this.grids[i].getPosition().y, 2));
...
//# sourceMappingURL=7a2e00877689cf2264ae2bec562b1d2515e76366.js.map