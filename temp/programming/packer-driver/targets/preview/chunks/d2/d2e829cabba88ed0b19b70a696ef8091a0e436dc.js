System.register(["cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Sprite', 'UIOpacity']);
      ...
      _export("Grid", Grid = (_dec = ccclass('Grid'), _dec(_class = class Grid extends Component {
        ...
        show() {
          this.node.getComponent(UIOpacity).opacity = 255; // this.node.getChildByName("Grid").getComponent(Sprite)
...
//# sourceMappingURL=d2e829cabba88ed0b19b70a696ef8091a0e436dc.js.map