      ...
      _export("GameArea", GameArea = (_dec = ccclass('GameArea'), _dec2 = property({
        ...
        getGridByPosition(pos) {
          ...
          for (var i = 0; i < 64; i++) {
            ...
            var distance = Math.sqrt(Math.pow(pos.x - this.node.getPosition().x - this.grids[i].getPosition().x, 2) + Math.pow(pos.y - this.node.getPosition().y - this.grids[i].getPosition().y + 40, 2));
...
//# sourceMappingURL=6366356d358919e96ae3a7c9f6f5f3754f7d6141.js.map