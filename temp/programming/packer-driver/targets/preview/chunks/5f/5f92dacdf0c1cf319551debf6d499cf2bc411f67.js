      ...
      _export("GameArea", GameArea = (_dec = ccclass('GameArea'), _dec2 = property({
        ...
        getGridByPosition(pos) {
          ...
          for (var i = 0; i < 64; i++) {
            ...
            var distance = Math.sqrt(Math.pow(pos.x - this.grids[i].getPosition().x - 320 + 40, 2) + Math.pow(pos.x - this.grids[i].getPosition().x - 440 + 40, 2));
...
//# sourceMappingURL=5f92dacdf0c1cf319551debf6d499cf2bc411f67.js.map