      ...
      _export("GameArea", GameArea = (_dec = ccclass('GameArea'), _dec2 = property({
        ...
        getGridByPosition(pos) {
          ...
          for (var i = 0; i < 64; i++) {
            ...
            var distance = Math.sqrt(Math.pow(pos.x - this.grids[i].getPosition().x, 2) + Math.pow(pos.x - this.grids[i].getPosition().x, 2));
...
//# sourceMappingURL=9164c64c342e480bf5b98f256af9508664355c3d.js.map