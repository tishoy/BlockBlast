System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, instantiate, Prefab, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, GameArea;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameArea", GameArea = (_dec = ccclass('GameArea'), _dec2 = property({
        ...
        createBlock() {
          for (var i = 0; i < 64; i++) {
            var node = instantiate(this.BlockPrefab);
...
//# sourceMappingURL=bea424f2e2b2d7e10b2370fc0d2028d4275be4c7.js.map