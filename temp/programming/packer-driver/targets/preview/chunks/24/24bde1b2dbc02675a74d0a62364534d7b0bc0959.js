      ...
      _export("GameArea", GameArea = (_dec = ccclass('GameArea'), _dec2 = property({
        ...
        getGridByPosition(pos) {
          ...
          for (var i = 0; i < 64; i++) {
            ...
            var distance = Math.sqrt(Math.pow(pos.x - this.node.getPosition().x - this.grids[i].getPosition().x, 2) + Math.pow(pos.y - this.node.getPosition().y - this.grids[i].getPosition().y - 120, 2));
...
//# sourceMappingURL=24bde1b2dbc02675a74d0a62364534d7b0bc0959.js.map