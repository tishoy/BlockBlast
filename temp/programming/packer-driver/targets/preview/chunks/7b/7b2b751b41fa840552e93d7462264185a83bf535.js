System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, instantiate, NodeEventType, Prefab, UIOpacity, UITransform, Vec2, Vec3, BlockEnum, GameController, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, Block;
      ...
      _export("Block", Block = (_dec = ccclass('Block'), _dec2 = property({
        ...
        touchCancel(event) {
          ...
          (_crd && GameController === void 0 ? (_reportPossibleCrUseOfGameController({
            error: Error()
          }), GameController) : GameController).Instance.test(new Vec2(this.node.getPosition().x - this.width, this.node.getPosition().y - this.height), {
            type: this.type,
...
//# sourceMappingURL=7b2b751b41fa840552e93d7462264185a83bf535.js.map