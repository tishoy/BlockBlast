System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, instantiate, NodeEventType, Prefab, UIOpacity, UITransform, Vec3, BlockEnum, GameController, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, Block;
      ...
      _export("Block", Block = (_dec = ccclass('Block'), _dec2 = property({
        ...
        touchCancel(event) {
          ...
          (_crd && GameController === void 0 ? (_reportPossibleCrUseOfGameController({
            error: Error()
          }), GameController) : GameController).Instance.test(this.node.getPosition(), {
            type: this.type,
...
//# sourceMappingURL=779e7958652a3f9eb3524c6a49fcc5dfb2e3812b.js.map