    ...
    execute: function () {
      ...
      _export("GameArea", GameArea = (_dec = ccclass('GameArea'), _dec2 = property({
        ...
        checkGameOver() {
          ...
          for (let j = 0; j < (_crd && GameController === void 0 ? (_reportPossibleCrUseOfGameController({
            error: Error()
            ...
            for (let i = 0; i < this.grids.length; i++) {
              let result = this.testBlockIndex(i, (_crd && GameController === void 0 ? (_reportPossibleCrUseOfGameController({
                error: Error()
...
//# sourceMappingURL=158fb4362273535451de0d9eacc38f21cb8e3d9f.js.map