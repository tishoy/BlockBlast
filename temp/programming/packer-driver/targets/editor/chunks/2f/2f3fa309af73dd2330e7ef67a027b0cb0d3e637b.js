      ...
      _export("GameArea", GameArea = (_dec = ccclass('GameArea'), _dec2 = property({
        ...
        getGridByPosition(pos) {
          ...
          for (let i = 0; i < 64; i++) {
            ...
            let distance = Math.sqrt(Math.pow(pos.x - this.grids[i].getPosition().x - 320 + 40, 2) + Math.pow(pos.x - this.grids[i].getPosition().x - 440 + 40, 2));
...
//# sourceMappingURL=2f3fa309af73dd2330e7ef67a027b0cb0d3e637b.js.map