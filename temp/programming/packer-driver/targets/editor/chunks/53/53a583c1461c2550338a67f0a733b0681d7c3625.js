    ...
    execute: function () {
      ...
      _export("Block", Block = (_dec = ccclass('Block'), _dec2 = property({
        ...
        touchMove(event) {
          ...
          this.node.setPosition(new Vec3(event.touch._point.x - event.touch._startPoint.x - this.width / 2, event.touch._point.y - event.touch._startPoint.y));
        }
...
//# sourceMappingURL=53a583c1461c2550338a67f0a733b0681d7c3625.js.map