  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameController", GameController = class GameController {
        ...
        test(pos, block) {
          let targetPos = this.gameArea.getComponent(_crd && GameArea === void 0 ? (_reportPossibleCrUseOfGameArea({
            error: Error()
...
//# sourceMappingURL=84e0fb92f8637f4613ad678b84ebf0faa1128531.js.map