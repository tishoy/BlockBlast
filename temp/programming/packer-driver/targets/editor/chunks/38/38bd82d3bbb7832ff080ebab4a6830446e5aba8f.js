System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, resources, SpriteFrame, ColorEnum, GameController, Block, _dec, _class, _crd, ccclass, property, Grid;
    ...
    execute: function () {
      ...
      _export("Grid", Grid = (_dec = ccclass('Grid'), _dec(_class = class Grid extends Component {
        ...
        show() {
          ...
          this.filled = true;
          let color = (_crd && GameController === void 0 ? (_reportPossibleCrUseOfGameController({
            error: Error()
          ...
          resources.load('texture/' + (_crd && ColorEnum === void 0 ? (_reportPossibleCrUseOfColorEnum({
            error: Error()
          }), ColorEnum) : ColorEnum).COLOR_RES[color] + "/spriteFrame", SpriteFrame, (err, asset) => {}); // this.node.getChildByName("Grid").getComponent(Sprite).spriteFrame = ;
...
//# sourceMappingURL=38bd82d3bbb7832ff080ebab4a6830446e5aba8f.js.map