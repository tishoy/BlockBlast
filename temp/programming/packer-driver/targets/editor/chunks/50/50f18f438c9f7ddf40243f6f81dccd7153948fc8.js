    ...
    execute: function () {
      ...
      _export("Block", Block = (_dec = ccclass('Block'), _dec2 = property({
        ...
        touchMove(event) {
          ...
          this.node.setPosition(new Vec3(event.touch._point.x - event.touch.start.x, event.touch._point - event.touch.start.y, 0));
        }
...
//# sourceMappingURL=50f18f438c9f7ddf40243f6f81dccd7153948fc8.js.map