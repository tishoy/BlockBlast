      ...
      _export("GameArea", GameArea = (_dec = ccclass('GameArea'), _dec2 = property({
        ...
        getGridByPosition(pos) {
          ...
          for (let i = 0; i < 64; i++) {
            ...
            let distance = Math.sqrt(Math.pow(pos.x - this.grids[i].getPosition().x - 320 + 40, 2) + Math.pow(pos.x - this.grids[i].getPosition().x - 320 + 40, 2));
...
//# sourceMappingURL=bafe8fccd15696fd27ed8a6d38ace4c5ec6af698.js.map