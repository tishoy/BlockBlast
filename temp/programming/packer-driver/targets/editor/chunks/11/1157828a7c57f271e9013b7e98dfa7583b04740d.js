      ...
      _export("GameArea", GameArea = (_dec = ccclass('GameArea'), _dec2 = property({
        ...
        getGridByPosition(pos) {
          ...
          for (let i = 0; i < 64; i++) {
            ...
            let distance = Math.sqrt(Math.pow(pos.x - this.node.getPosition().x + this.grids[i].getPosition().x + 40, 2) + Math.pow(pos.y - this.node.getPosition().y + this.grids[i].getPosition().y - 120 + 40, 2));
...
//# sourceMappingURL=1157828a7c57f271e9013b7e98dfa7583b04740d.js.map