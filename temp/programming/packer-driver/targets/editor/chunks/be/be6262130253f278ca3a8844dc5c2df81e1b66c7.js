      ...
      _export("GameArea", GameArea = (_dec = ccclass('GameArea'), _dec2 = property({
        ...
        getGridByPosition(pos) {
          ...
          for (let i = 0; i < 64; i++) {
            ...
            let distance = Math.sqrt(Math.pow(pos.x - this.node.getPosition().x - this.grids[i].getPosition().x, 2) + Math.pow(pos.y - this.node.getPosition().y - this.grids[i].getPosition().y + 40, 2));
...
//# sourceMappingURL=be6262130253f278ca3a8844dc5c2df81e1b66c7.js.map