  ...
  return {
    ...
    execute: function () {
      ...
      _export("Block", Block = (_dec = ccclass('Block'), _dec2 = property({
        ...
        touchMove(event) {
          console.log(event.touch._point.x, event.touch._point.y);
          this.node.setPosition(new Vec3(event.touch._point.x, event.touch._point.y));
        }
...
//# sourceMappingURL=4341919079618c14bf00c5738228fd6a4277897f.js.map