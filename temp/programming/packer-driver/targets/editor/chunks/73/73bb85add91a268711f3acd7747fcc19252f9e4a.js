      ...
      _export("GameArea", GameArea = (_dec = ccclass('GameArea'), _dec2 = property({
        ...
        getGridByPosition(pos) {
          ...
          for (let i = 0; i < 64; i++) {
            ...
            let distance = Math.sqrt(Math.pow(pos.x - this.grids[i].getPosition().x + 40, 2) + Math.pow(pos.y - this.grids[i].getPosition().y - 120 + 40, 2));
...
//# sourceMappingURL=73bb85add91a268711f3acd7747fcc19252f9e4a.js.map