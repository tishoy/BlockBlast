      ...
      _export("GameArea", GameArea = (_dec = ccclass('GameArea'), _dec2 = property({
        ...
        getGridByPosition(pos) {
          ...
          for (let i = 0; i < 64; i++) {
            ...
            let distance = Math.sqrt(Math.pow(pos.x - this.grids[i].getPosition().x, 2) + Math.pow(pos.x - this.grids[i].getPosition().x, 2));
...
//# sourceMappingURL=5c4ac297b7629009b72552274ed71ccb680f644a.js.map