        ...
        generate() {
          ...
          for (let i = 0; i < data.length; i++) {
            ...
            console.log((_crd && ColorEnum === void 0 ? (_reportPossibleCrUseOfColorEnum({
              error: Error()
            }), ColorEnum) : ColorEnum).COLOR_RES[this.color]);
            resources.load('texture/' + (_crd && ColorEnum === void 0 ? (_reportPossibleCrUseOfColorEnum({
              error: Error()
            }), ColorEnum) : ColorEnum).COLOR_RES[this.color], SpriteFrame, (err, asset) => {
...
//# sourceMappingURL=fac45066d28345baab68c802c6b1e64ce841bf73.js.map